...
3. All the GISAID samples listed in other files (that read as gisaid_hcov-19*.csv) were used to analyze the evolution trends for different clades shown in Figure 5.
